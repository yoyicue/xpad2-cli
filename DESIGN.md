...
状态：v0.4.9 已实现；v0.1.1 完成 BoomInstaller 依赖身份和公开分发材料，v0.1.2
...
```json
{
  ...
  "version": "0.2.5",
  "kind": "cli",
  "sha256": "cd21bb7b4df089361e45b72096e11aa639ec57675e6012097341dfc14ee9f388",
  "size": 89072,
...
版本、精确 `/260` profile，以及 ELF、legacy cache ZIP、catalog 的文件名、大小、
...
-> 候选 ELF 自检自身哈希、内嵌 catalog 和真机 profile
...
| `xpad-install` | v0.2.5 | `cd21bb7b4df089361e45b72096e11aa639ec57675e6012097341dfc14ee9f388` |
| BoomInstaller | v13.6.0.r15.889f53c production | `72ff17f48cab99f6ff51c072e3363952de379347e07da242ce2150327802f200` |
...
36. 官方 `moe.shizuku.privileged.api` 已安装时，BoomInstaller r15 仍能经健康 0044 安装，
